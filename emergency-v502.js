...
function init(){
 ...
 function vehicle(job,d){
   ...
   g.userData=Object.assign(g.userData||{},{emergency500:true,emergency502:true,job,halfW:job==='Feuerwehr'?1.36:(job==='Polizist'?1.04:1.18),halfL:job==='Feuerwehr'?3.45:(job==='Polizist'?2.35:2.8),r:job==='Feuerwehr'?3.65:(job==='Polizist'?2.35:2.8)});
