  ...
  function home(){
    ...
    appShell('Lux City Handy',`
      <div class="lcPhoneGrid">
        ...
        <button data-app="map"><span>🗺️</span>Karte<small>Wohnungen & Zuhause</small></button>
      </div>
      <div class="lcPhoneFoot">H · Handy schließen</div>`);
    document.querySelectorAll('[data-app]').forEach(b=>b.onclick=()=>({bank:openBank,insurance:openInsurance,tax:openTax,bills:openBills,map:()=>{toggle(false);window.LuxCityMap810?.open?.()}}[b.dataset.app])())
  }
