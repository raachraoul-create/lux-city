...
'#roadmap722 .tag{font-size:9px;font-weight:900;border-radius:99px;padding:2px 5px;height:max-content;white-space:nowrap}.tagPlan{background:#273747;color:#b9d7ef}.tagDone{background:#244d33;color:#b9f2ca}'+
...
document.getElementById('rmNext722').innerHTML=NEXT.map((t,i)=>'<div class="rmRow"><span class="tag tagPlan">GEPLANT</span><span>'+(i+1)+'. '+t+'</span></div>').join('');
...
window.LuxRoadmap722={next:NEXT,done:DONE}})();