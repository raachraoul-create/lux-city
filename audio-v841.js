...
function init(){
 ...
 function aiHorn(){tone(330,.16,.022,'triangle')}function fireSiren(){tone(690,.46,.040,'sine',880);setTimeout(()=>tone(510,.48,.038,'sine',650),420)}
 ...
 window.LuxAudio520=window.LuxAudio530=window.LuxAudio540=window.LuxAudio550=window.LuxAudio560=window.LuxAudio570=window.LuxAudio680=window.LuxAudio710=window.LuxAudio840=window.LuxAudio841={unlock,horn,aiHorn,fireSiren,door,warningBeep,bell,impact,get active(){return unlocked&&!muted&&ctx?.state==='running'}}
}})();